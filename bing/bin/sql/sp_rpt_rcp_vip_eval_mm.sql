...
0 as dagg_num,
0 as doubi_reward,
count(case when tt.cateid=31 then tt.topicid end) as topic_num_31,
count(case when tt.cateid=32 then tt.topicid end) as topic_num_32,
count(case when tt.cateid=33 then tt.topicid end) as topic_num_33
...
and tt.cateid in (5,6,8,31,32,33) and tt.status=1
group by tt.userid
;
...
sum(dagg_num),
case 
when (sum(topic_num_6)+sum(topic_num_8)+sum(topic_num_31)+sum(topic_num_32)+sum(topic_num_33))>=1 and sum(comment_num)>=50 and sum(recipe_num_4s)>=10 then 1500
when (sum(topic_num_6)+sum(topic_num_8)+sum(topic_num_31)+sum(topic_num_32)+sum(topic_num_33))>=1 and sum(comment_num)>=50 and (sum(record_recipe_num)+sum(recipe_num_4s))>=10 then 1200
when (sum(topic_num_6)+sum(topic_num_8)+sum(topic_num_31)+sum(topic_num_32)+sum(topic_num_33))>=1 and sum(comment_num)>=50 and (sum(record_recipe_num)+sum(recipe_num_4s))>=5 then 800
