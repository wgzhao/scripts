...
--工单HAODOU-9301 除“菜谱专辑达人”“生活盟主”“好豆大咖”外所有标签即为菜谱达人
...
from haodou_center_${nextdaydate}.VipUser v 
left semi join
(select userid, concat_ws(',',collect_set(cast(tagid as string))) as expert_style 
from haodou_center_${nextdaydate}.VipUserTag 
where tagid not in (10038,10043,10060)
group by userid) tg
